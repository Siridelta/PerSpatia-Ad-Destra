...
export const MonacoLikeCodeEditor: CodeEditorComponent = ({
  initialText,
  onTextChange,
  onExitEdit,
  className = '',
  ...
  // 语法高亮HTML
  const highlightedHtml = useMemo(() => generateHighlightedCode(text), [text, generateHighlightedCode]);
  ...
  return (
    <div className={`code-editor ${className}`} style={{ position: 'relative', ...style }}>
      {/* 占位元素 - 在文档流中，决定容器高度，宽度为1px */}
      <div
        className="code-editor-placeholder"
        style={{
          width: '1px',
          height: '100px', // 初始高度，会被 adjustSize 更新
          visibility: 'hidden',
          margin: 0,
          padding: '8px',
...
export default MonacoLikeCodeEditor;
